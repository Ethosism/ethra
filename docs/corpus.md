...
```text
items 2,720 / 10,000 for v1.0
tracks  6 / 6 represented
balance daily 544, civic 408, ritual 408, technical 544, poetic 544, learner 272
```
...
For the current v0.6.7 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-545`, `civic-409`, `ritual-409`, `tech-545`, `poetic-545`, and `learner-273`.
