...
For the current v0.7.4 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-617`, `civic-463`, `ritual-463`, `tech-617`, `poetic-617`, and `learner-309`.
