...
Ethra currently has 14,057 explicit lexicon entries and 700 reviewed corpus items after the v0.3.5 human-depth corpus grounding. That is enough to support early structured use across more domains, not enough to function as a complete language.
...
The main remaining v0.5 gaps are root depth, now 700 / 1,000, and reviewed corpus depth, now 700 / 2,000.
