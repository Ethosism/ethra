...
Status: v0.3.4 human-depth expansion, generated YAML data, productive derivation patterns, expanded root-bank coverage, 600 reviewed corpus items, TypeScript CLI, compound terminology, corpus/governance planning, and tests.
