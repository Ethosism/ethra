...
For the current v0.7.8 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-665`, `civic-499`, `ritual-499`, `tech-665`, `poetic-665`, and `learner-333`.
