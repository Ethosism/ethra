...
```text
items 4,280 / 10,000 for v1.0
tracks  6 / 6 represented
balance daily 856, civic 642, ritual 642, technical 856, poetic 856, learner 428
```
...
For the current v0.9.4 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-857`, `civic-643`, `ritual-643`, `tech-857`, `poetic-857`, and `learner-429`.
