...
```text
items 1,500 / 2,000 for v0.5
tracks  6 / 6 represented
balance daily 282, civic 234, ritual 234, technical 282, poetic 282, learner 186
```
...
For the current v0.3.16 state, the next 120-item batch should add 28 daily, 16 civic, 16 ritual, 28 technical, 28 poetic, and 4 learner items, starting at `daily-283`, `civic-235`, `ritual-235`, `tech-283`, `poetic-283`, and `learner-187`.
