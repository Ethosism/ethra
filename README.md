...
Status: v0.3.17 applies the fifth governed corpus expansion batch after the planner release: generated YAML data, productive derivation patterns, expanded root-bank coverage, 1,620 reviewed corpus items, TypeScript CLI, compound terminology, corpus/governance planning, and tests.
...
- **Corpus:** 1,620 reviewed seed corpus items across daily dialogue, civic/legal, ritual/vow, technical/software, literary/poetic, and learner tracks.
...
- Expand from 1,620 to 2,000 reviewed corpus items.
