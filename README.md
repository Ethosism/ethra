...
Status: v0.7.0 has passed the public-culture gate and begun the v1.0 expansion program: generated YAML data, productive derivation patterns, 1,400 root families, 28,057 lexicon entries, 28,212 dictionary entries, 2,840 reviewed corpus items, TypeScript CLI, compound terminology, sentence parsing, corpus search, dictionary lookup, governed style checking, governed term proposal packets, corpus/governance planning, and tests.
...
- **Roots:** 1,400 root families with 20 productive derivation patterns per root.
...
- **Lexicon:** generated core lexicon with 28,057 explicit entries across pronouns, particles, moral agency, family, body, mind, emotion, seeing/knowing, speech, time, nature, building/making, law/civic life, technology, ritual/poetry, love/intimacy, conflict/repair, and future/civilization.
...
- **Corpus:** 2,840 reviewed seed corpus items across daily dialogue, civic/legal, ritual/vow, technical/software, literary/poetic, and learner tracks.
...
- Expand from 1,400 to 2,500 root families.
- Expand from 2,840 to 10,000 reviewed corpus items.
