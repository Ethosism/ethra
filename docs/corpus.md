...
For the current v0.9.8 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-905`, `civic-679`, `ritual-679`, `tech-905`, `poetic-905`, and `learner-453`.
