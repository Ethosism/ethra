...
Status: v0.5.0 meets the public-culture corpus gate: generated YAML data, productive derivation patterns, expanded root-bank coverage, 2,000 reviewed corpus items, TypeScript CLI, compound terminology, corpus/governance planning, and tests.
...
- **Corpus:** 2,000 reviewed seed corpus items across daily dialogue, civic/legal, ritual/vow, technical/software, literary/poetic, and learner tracks.
...
- Expand from 20,057 to 25,000 explicit entries.
- Expand from 1,000 to 2,500 root families.
- Expand from 2,000 to 10,000 reviewed corpus items.
