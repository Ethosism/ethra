...
Status: v0.3.6 public-institution root expansion, generated YAML data, productive derivation patterns, expanded root-bank coverage, 700 reviewed corpus items, TypeScript CLI, compound terminology, corpus/governance planning, and tests.
