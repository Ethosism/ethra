...
For the current v0.10.4 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-977`, `civic-733`, `ritual-733`, `tech-977`, `poetic-977`, and `learner-489`.
