...
Status: v0.5.1 has passed the public-culture corpus gate and begun the v1.0 corpus program: generated YAML data, productive derivation patterns, expanded root-bank coverage, 2,120 reviewed corpus items, TypeScript CLI, compound terminology, corpus/governance planning, and tests.
...
- Expand from 2,120 to 10,000 reviewed corpus items.
