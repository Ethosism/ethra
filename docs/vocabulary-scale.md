...
Ethra currently has 23,057 explicit lexicon entries, 23,212 dictionary entries, 1,150 root families, and 2,360 reviewed corpus items after the v0.6.1 corpus grounding batch. The v0.5 entry, root, and corpus gates are met; the next scale target is v1.0 stable civil language.

Current progress toward the v1.0 stable-civil-language target:

```text
entries 23,057 / 25,000
dictionary 23,212 entries with corpus evidence fields
roots     1,150 / 2,500
...
The next numeric gaps are v1.0 gaps: 1,943 more explicit entries, 1,350 more root families, and 7,640 more reviewed corpus items.
