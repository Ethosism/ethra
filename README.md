...
Status: v0.3.10 corpus grounding, generated YAML data, productive derivation patterns, expanded root-bank coverage, 900 reviewed corpus items, TypeScript CLI, compound terminology, corpus/governance planning, and tests.
...
- **Corpus:** 900 reviewed seed corpus items across daily dialogue, civic/legal, ritual/vow, technical/software, literary/poetic, and learner tracks.
...
- Expand from 900 to 2,000 reviewed corpus items.
