...
```text
items 3,200 / 10,000 for v1.0
tracks  6 / 6 represented
balance daily 640, civic 480, ritual 480, technical 640, poetic 640, learner 320
```
...
For the current v0.7.5 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-641`, `civic-481`, `ritual-481`, `tech-641`, `poetic-641`, and `learner-321`.
