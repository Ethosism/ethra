...
```text
items 3,560 / 10,000 for v1.0
tracks  6 / 6 represented
balance daily 712, civic 534, ritual 534, technical 712, poetic 712, learner 356
```
...
For the current v0.8.1 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-713`, `civic-535`, `ritual-535`, `tech-713`, `poetic-713`, and `learner-357`.
