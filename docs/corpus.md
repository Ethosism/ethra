...
```text
items 2,600 / 10,000 for v1.0
tracks  6 / 6 represented
balance daily 520, civic 390, ritual 390, technical 520, poetic 520, learner 260
```
...
For the current v0.6.6 state, the next 120-item batch points toward v1.0: 24 daily, 18 civic, 18 ritual, 24 technical, 24 poetic, and 12 learner items, starting at `daily-521`, `civic-391`, `ritual-391`, `tech-521`, `poetic-521`, and `learner-261`.
